...
void perception::update(float MO)
{
    ...
    float NEAR_APMODI = 0.80;    /*threshold avoidance modi near */
    float NEAR_AVMODI = 0.80;    /*threshold avoidance modi near */
    /// added on 26 december
    float TOUC_APMODI = 0.12;     /*threshold avoidance modi touched */
    float TOUC_AVMODI = 0.18;     /*threshold avoidance modi touched */
