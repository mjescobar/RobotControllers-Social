...
protoarch = " ./proto_arch_MFOL_0 "
echo = " echo "

experiment_name = "exp2_1_1"				#mo bf eo
dummybot = "-mo 1.0 -delay 2 -mfol 0 -ofol -1 -mow 0.9548 0.5 0.5 "
dummyname = "_-1.0_0.9_0.5_0.5"
testbot = "-mo -1.0 -delay 2 -mfol -1 -ofol -1 -mow 0.9548 0.5 0.5 "
